...
import com.neu.edu.context.CurrentUserUtil;
...
import com.neu.edu.repo.CustomerRepo;
import com.neu.edu.repo.MedicineRepo;
import com.neu.edu.repo.OrdersRepo;
import com.neu.edu.repo.UsersRepo;
import com.neu.edu.request.*;
import com.neu.edu.response.CommonResponse;
...
import static com.neu.edu.response.MediVaultMessages.*;
    ...
    public CommonResponse createOrder(NewOrderRequest request) {
        ...
        return customerRepo.findByPhoneNumber(request.getCustomerMobileNumber())
                .map(customer -> {
                    ...
                    orders.setOrderTotal(medicine.getPrice());
