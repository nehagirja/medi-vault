        ...
        <div className='popup'>
            <div className='popup-content'>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <input placeholder='Customer Mobile'  {...register("customerMobileNumber", { minLength: 1 })} />
                    {errors?.customerMobileNumber?.type === "required" && <p>This field is required</p>}
                    {errors?.customerMobileNumber?.type === "minLength" && <p>First name cannot be empty</p>}
